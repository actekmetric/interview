# QA Environment - AWS Managed Prometheus Configuration
...
inputs = {
  ...
  # Alert email for QA environment
  alert_email = "qa-alerts@example.com" # TODO: Update with actual email

  # Retention period for QA (14 days)
